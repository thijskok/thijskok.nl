<header class="blog-header py-3">
    <div class="row flex-nowrap justify-content-between align-items-center">
        <div class="col-4 pt-1">
            <p class="my-auto">
                <a href="https://twitter.com/@thijskok" class="pr-3 text-decoration-none" target="_blank" rel="noopener">
                ...
                <a href="https://github.com/thijskok/" class="text-decoration-none" target="_blank" rel="noopener">
